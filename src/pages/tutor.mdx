...
I have significant experience working in Python, C++, Java, JavaScript/Typescript, SQL, R, PHP, and HTML/CSS.

I've also used Bash/zsh, C, Swift, Assembly, SAS, Scala, Lua, Scheme, and Clojure.
