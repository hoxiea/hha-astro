...
After playing with computers for almost 30 years, I'm finally approaching a setup that I love. (We've come a long way... 🖼️) I thought it would be fun to document it here - who doesn't love a good [uses](https://uses.tech/) page?
...
A major selling point for the M2 Max was its ability to drive three 4K monitors:

- Center: **27" Dell P2715Q**. Going strong since 2017!
- Left: **27" LG UN850-W**. Comparable to the Dell in quality.
- Right: **27" Samsung Whatever**. My partner's company sent her two of these for remote work, and despite looking like a potato compared to the other two, it does give me more pixels to work with 🤷🏻
...
My workflow is keyboard-optimized, but I'm not mouse-free. I have a [Kensington Expert Mouse](https://a.co/d/cO7DR0p) to the left of my keyboard, the latest in a long line of ergonomic experiments. I often have an [XP Pen](https://www.xp-pen.com/) graphics tablet to the right, too - the original use case was tutoring, but it's also great for thinking through technical challenges.

For audio output, I use standard [Apple wired headphones](https://www.apple.com/shop/product/MNHF2AM/A/earpods-35mm-headphone-plug?fnode=&fs=fh%3D47d1%252B45a8). Something wireless would be nice, but I've never seen something wireless that could handle 11 hours straight of tutoring with 100% reliability. (If I had a nickel for every time a student fumbled with wireless audio settings, I'd have a lot of nickels 💰)

Tying it all together is a [CalDigit TS3 Plus dock](https://a.co/d/5tBomdA). It wasn't cheap, but the ability to make all this work with just two cables is worth it. I also have an [Anker USB 3.0 hub](https://a.co/d/3zOG96r) for extra USB ports that are easily accessed - occasionally I need to unplug and replug something to get it working again, and it's nice to make that easy.
...
- [Focusmate](https://app.focusmate.com/user/hamilton) for accountability and productivity. FM has been game-changing for me in terms of actually sitting down and crunching... some combination of the consistency principle, time blocking, and black magic? (If you're interested in joining, consider using my [referral link](focusmate.com/?fmreferral=1z9cLIutON) for a free month of Premium!)
