...
import deskPicture from "../images/desk.jpg";
...
- [Freedom](https://freedom.to/) to block distracting content
...
- [Kiva](https://www.kiva.org/) for microlending and making the world a better place. I created an [account](https://www.kiva.org/lender/hhackerman) and set up small, automatic monthly deposits when I graduated from BU. {new Date().getFullYear() - 2009} years later, I'm in the 90+ percentile for lenders, having made about 90 loans to individuals in more than 30 countries.
