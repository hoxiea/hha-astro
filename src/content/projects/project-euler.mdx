...
export const percentile_update = "June 2025";
export const numSolved = 150;
export const percentile = 0.491;
export const nextMilestone =
  numSolved % 10 === 0 ? numSolved + 10 : numSolved + (10 - (numSolved % 10));
...
<figure class="flex flex-col justify-center items-center">
  ...
  <figcaption class="mt-0">
    My Project Euler progress. Next stop: {nextMilestone}!
  </figcaption>
</figure>

As of {percentile_update}, {numSolved} solutions is good enough to put me in the top {percentile}% of solvers. But it's less about the global statistics and more about the fun of approaching problems from different angles and perspectives until you have that **aha!** moment.
